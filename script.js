...
function getLogoPath(teamName) {
  const mapping = {
    ...
    "AC Milan": "italy_milan_256x256.football-logos.cc.png"
  };
...
let html = `${renderSeasonManager()}<div style="margin:16px 0; padding:12px; background:#1b1b1b; border-radius:10px;">
    ...
    if (tie.legs === 1) {
      html += `
        <div style="margin:12px 0; padding:10px; border:1px solid #333; border-radius:8px;">
          <div style="font-weight:bold; margin-bottom:6px;">${formatTeamWithLogo(tie.home)} vs ${formatTeamWithLogo(tie.away)}</div>
          <div style="margin-bottom:6px;">
            ${formatTeamWithLogo(tie.home)}
      ...
      html += `
        <div style="margin:12px 0; padding:10px; border:1px solid #333; border-radius:8px;">
          <div style="font-weight:bold; margin-bottom:8px;">${formatTeamWithLogo(tie.home)} vs ${formatTeamWithLogo(tie.away)}</div>

          <div style="margin-bottom:6px;">
            Leg 1: ${formatTeamWithLogo(tie.home)}
            <input id="k-${currentRound}-${tie.id}-l1-h" type="number" value="${snap.leg1?.h ?? ""}" style="width:60px;"> -
            <input id="k-${currentRound}-${tie.id}-l1-a" type="number" value="${snap.leg1?.a ?? ""}" style="width:60px;">
            ${formatTeamWithLogo(tie.away)}
          </div>
          ...
          <div style="margin-bottom:6px;">
            Leg 2: ${formatTeamWithLogo(tie.away)}
